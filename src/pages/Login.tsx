          ...
          <div className="max-w-md mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Sign in to continue your Diani Beach adventure
              </p>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-ocean hover:bg-ocean-dark text-white mt-6"
                  >
                    Sign In
                  </Button>
                  ...
                  <Button 
                    ...
                    onClick={() => {
                      toast({
                        ...
                        description: "This would connect to Google OAuth in production.",
                        duration: 3000,
                      });
                    }}
                  >
